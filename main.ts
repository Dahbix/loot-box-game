...
sprites.onDestroyed(SpriteKind.Box, function (sprite) {
    _1Code = "ThisDoesNotExist1"
    _2Code = "ThisDoesNotExist2"
    _3Code = "ThisDoesNotExist3"
...
function GetCode (NameOfPrize: string, extra: boolean) {
    if (Countdown_Time == 3423423245678998500) {
...
/**
 * DO NOT REMOVE OR LOOK UNDER!!!!
 * 
 * TOP SECRET!!!!!!
 * 
 * THIS IS NOT A JOKE!!! CODES ARE IN HERE!!! PLEASE DO NO LOOK HERE!!
 * 
 * TOP SECRET TOP SECRET TOP SECRET TOP SECRET TOP SECRET TOP SECRET TOP SECRET TOP SECRET TOP SECRET TOP SECRET TOP SECRET TOP SECRET TOP SECRET TOP SECRET TOP SECRET TOP SECRET TOP SECRET TOP SECRET TOP SECRET TOP SECRET TOP SECRET TOP SECRET TOP SECRET TOP SECRET TOP SECRET TOP SECRET TOP SECRET TOP SECRET
 */
/**
 * DO NOT REMOVE OR LOOK UNDER!!!!
 * 
